...
class wx_robot(object):
    ...
    def time_send(self):
        ...
        city = '信阳'
        text = self.get_weatherinfo(city)
        self.wx.send_text(to_user='ych111126', msg='早安')
        time.sleep(1)
        self.wx.send_text(to_user='ych111126', msg=text)
        time.sleep(1)
        self.wx.send_text(to_user='ych111126', msg=eng)
        time.sleep(1)
        self.wx.send_text(to_user='ych111126', msg=cn)
        time.sleep(1)
